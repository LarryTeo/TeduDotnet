...
using eShopSolution_.Ulities.Exceptions;
using System;
...
namespace eShopSolution.Application.Catalog.Products
{
    public class ManageProductService : IManagedProductService
    {
        ...
        public async Task<PageResult<ProductViewModle>> GetAllPaging(GetProductPagingRequest request)
        {
            //1. select join
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            var productTranlations = await _context.ProductTranslations.FirstOrDefaultAsync(x => x.ProductId == request.Id && x.LanguageId ==request.LaguageId);

            if(product == null || productTranlations ==null ) throw new EShopException($"Cannot find product: {request.Id}");
        ...
        public async Task<bool> UpdatePrice(int productId, decimal newPrice)
        {
            ...
            return await _context.SaveChangesAsync() > 0; // greater than  is true
